...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DSi5eLcI.js
...
var styles_default = "/assets/styles-Dm-UNWk6.css";
var APP_NAME = "Nekyia";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "A first-person descent through the inner labyrinth. Dream-images wait to be met."
			},
			{
				name: "theme-color",
				content: "#0c0b0a"
...
var $$splitComponentImporter = () => import("./routes-D6Fp65R_.mjs");
